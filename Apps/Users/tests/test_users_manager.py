...
class TestUsersManagers:
    ...
    def test_create_user_fails_with_email_and_without_password(self) -> None:
        user_model: Model = get_user_model()
        with raises(TypeError):
            user_model.objects.create_user(email="email@test.com", password="")
    ...
    def test_create_superuser(self) -> None:
        user_model: Model = get_user_model()
        admin_user: User = user_model.objects.create_superuser(
    ...
    def test_create_superuser_fails_with_email_without_password(self) -> None:
        user_model: Model = get_user_model()
        with raises(TypeError):
            user_model.objects.create_superuser(email="", password="foo")
