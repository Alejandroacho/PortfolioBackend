...
class TestRetrieveEndpoint:
    ...
    def test_list_works(self) -> None:
        ...
        assert response.data[0]["introduction"] == project.introduction
        assert response.data[0]["description"] == project.description
        assert response.data[0]["url"] == project.url
        assert response.data[0]["repository"] == project.repository
        assert (
        ...
        assert response.data[1]["title"] == project2.title
        assert response.data[1]["introduction"] == project2.introduction
        assert response.data[1]["description"] == project2.description
        assert response.data[1]["url"] == project2.url
        assert response.data[1]["repository"] == project2.repository
        assert (
